...
$customer = new Customer('Sara', 'sara@bianchi.it', 'via roma 24');
$account = new Account($customer, $customer->insertCreditCard(new CreditCard('678 567 543 5678', '564', 5, 2024)));
$account->register($customer);

$customerCart = new Cart($customer);
$customerCart->addProduct(new PetHouse('L 48 x P 42 x H 24 cm', 'Polyester, wood', 'Lettino a parete Natural Paradise Dahlia', 29.49, new Category('cat'), 'https://shop-cdn-m.mediazs.com/bilder/lettino/a/parete/natural/paradise/dahlia/8/800/67124_np_wandliegebett_1000x1000_logo_la_dsc0187_8.jpg'), 1);
$customerCart->addProduct(new Food('Tonno e Merluzzo', '280g', 'Tonno Skipjack (29,5%), merluzzo (27,5%), riso (3%).
', 'Umido', 'Almo Nature HFC 6 x 280 g / 290 g', 15.49, new Category('dog'), 'https://shop-cdn-m.mediazs.com/bilder/almo/nature/hfc/x/g/g/7/800/184097_pla_almonature_hfc_thunfisch_kabelhau_290g_hs_01_7.jpg'), 3);

$customerTotal = $customerCart->getTotal();

try {
    $paymentMessage = $customer->makePayment($totalAmount);
    //echo $paymentMessage;
} catch (Exception $e) {
    //echo $e->getMessage();
}
